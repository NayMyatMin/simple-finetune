...
#SBATCH --output=%u.consistency          # Log file location
...
#SBATCH --job-name=consistency               # Job name (set for running LLaMA-2-7b)
...
srun --gres=gpu:1 torchrun --nproc_per_node=1 --master_port=11223\
        consistency_train.py configs/consistency/llama2_7b_chat/llama2_7b_consistency_original.yaml
